...
{
	LuaFunctionWrap<T>* functionWrap = (LuaFunctionWrap<T>*)calloc(1, sizeof(LuaFunctionWrap<T>));//conf_calloc(1, sizeof(LuaFunctionWrap<T>));
...
{
	IScriptCallbackWrap* lambdaWrap = (IScriptCallbackWrap*)calloc(1, sizeof(LuaFunctionWrap<T>));//conf_calloc(1, sizeof(ScriptCallbackWrap<T>));
